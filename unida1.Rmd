...
sliderInput("z", "Valor de z", -3.5, 3.5, 0, 0.01)

renderText({paste("Pr(Z < ", input$z, ") =", round(pnorm(input$z), 4))})
renderPlot({graf.nor.s(input$z, col = 2)
  mtext(paste("Pr(Z <", input$z, ") = ", round(pnorm(input$z), 4)), col = 2, lwd = 8, cex =1.2)
  title("Distribución normal estándar")}, width = 500, height = 300)
