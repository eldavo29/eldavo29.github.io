...
El procedimiento para realizar las comparaciones consiste en tomar una muestra aleatoria de cada población, calcular los estadísticos, definir un nivel de cofianza y realizar la inferencia de diferencia de medias. 

Para realizar las comparaciones es necesario conocer la distribción muestral de 
...
Se puede esperar que la distribución muestral de $\bar{X}_1-\bar{X}_2$ está distribuida de forma aproximadamente normal con media $\mu_{\bar{x}_1}-\mu_{\bar{x}_2}=\mu_1-\mu_2$ y desviación estándar $\sigma_{\bar{X}_1-\bar{X}_2} = \sqrt{\sigma^2_1/n_1+\sigma^2_2/n_2}$
